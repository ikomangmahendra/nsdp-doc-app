...
import { sampleWithRequiredData } from '../section.test-samples';
...
describe('Section Management Component', () => {
  ...
  beforeEach(() => {
    ...
    jest
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '682b002b-db5c-422d-8e5a-8b1b60f2decf' }],
      ...
      .mockReturnValueOnce(
        of(
          new HttpResponse({
            body: [{ id: '4465a596-1b29-45d8-93ab-ee4274ad08a4' }],
            headers: new HttpHeaders({
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.sections()[0]).toEqual(expect.objectContaining({ id: '682b002b-db5c-422d-8e5a-8b1b60f2decf' }));
  });
